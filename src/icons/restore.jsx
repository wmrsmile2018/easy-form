...
export const Restore = ({ className, ...rest }) => {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <g data-id={id} fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
        <g data-id={id} transform="translate(-577 -553)">
          <g data-id={id} transform="translate(100 100)">
            <g data-id={id} transform="translate(476 450)">
              <path data-id={id} d="M0 0L24 0 24 24 0 24z"></path>
              <path
                data-id={id}
                fill="#1D1D1D"
